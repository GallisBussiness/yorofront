...
import {
  PaiementClient,
  PaiementClientDocument,
} from './entities/paiement-client.entity';
import { InjectModel } from '@nestjs/mongoose';
import { Model } from 'mongoose';

@Injectable()
export class PaiementClientService extends AbstractModel<
  PaiementClient,
  CreatePaiementClientDto,
  UpdatePaiementClientDto
> {
  constructor(
    @InjectModel(PaiementClient.name)
    private readonly paiementClient: Model<PaiementClientDocument>,
  ) {
