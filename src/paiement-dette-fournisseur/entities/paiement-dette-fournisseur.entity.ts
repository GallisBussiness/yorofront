...
export type PaiementDetteFournisseurDocument =
  HydratedDocument<PaiementDetteFournisseur>;
...
export const PaiementDetteFournisseurSchema = SchemaFactory.createForClass(
