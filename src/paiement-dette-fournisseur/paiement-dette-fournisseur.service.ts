...
import {
  PaiementDetteFournisseur,
  PaiementDetteFournisseurDocument,
} from './entities/paiement-dette-fournisseur.entity';
import { InjectModel } from '@nestjs/mongoose';
import { Model } from 'mongoose';

@Injectable()
export class PaiementDetteFournisseurService extends AbstractModel<
  PaiementDetteFournisseur,
  CreatePaiementDetteFournisseurDto,
  UpdatePaiementDetteFournisseurDto
> {
  constructor(
    @InjectModel(PaiementDetteFournisseur.name)
    private readonly paiementDetteFournisseurModel: Model<PaiementDetteFournisseurDocument>,
  ) {
