...
import {
  PaiementFournisseur,
  PaiementFournisseurDocument,
} from './entities/paiement-fournisseur.entity';
import { Model } from 'mongoose';
import { InjectModel } from '@nestjs/mongoose';

@Injectable()
export class PaiementFournisseurService extends AbstractModel<
  PaiementFournisseur,
  CreatePaiementFournisseurDto,
  UpdatePaiementFournisseurDto
> {
  constructor(
    @InjectModel(PaiementFournisseur.name)
    private readonly paiementFournisseurModel: Model<PaiementFournisseurDocument>,
  ) {
