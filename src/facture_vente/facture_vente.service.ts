...
import {
  FactureVente,
  FactureVenteDocument,
} from './entities/facture_vente.entity';
import { InjectModel } from '@nestjs/mongoose';
import { Model } from 'mongoose';

@Injectable()
export class FactureVenteService extends AbstractModel<
  FactureVente,
  CreateFactureVenteDto,
  UpdateFactureVenteDto
> {
  constructor(
    @InjectModel(FactureVente.name)
    private readonly factureVenteModel: Model<FactureVenteDocument>,
  ) {
